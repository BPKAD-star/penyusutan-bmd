...
export default function Page() {
  ...
  return (
    <div>
      ...
      {mode === 'manual'
        ? <PerolehanManual kategori="hasil_inventarisasi" judul="Hasil Inventarisasi" pihakLabel={null} />
        : <PerolehanImport jenis="hasil_inventarisasi" label="Hasil Inventarisasi" />}
    </div>
  )
}
