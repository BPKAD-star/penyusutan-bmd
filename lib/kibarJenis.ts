...
export const KIBAR_JENIS_LABEL: Record<string, { label: string; tone: Tone }> = {
  ...
  batal_pemanfaatan: { label: 'Pembatalan Pemanfaatan (Koreksi Salah Catat)', tone: 'keluar' },
  pengamanan: { label: 'Pengamanan (Serah ke Penanggung Jawab)', tone: 'netral' },
  pengembalian_pengamanan: { label: 'Pengembalian Pengamanan', tone: 'netral' },
  batal_pengamanan: { label: 'Pembatalan Pengamanan (Koreksi Salah Catat)', tone: 'keluar' },
