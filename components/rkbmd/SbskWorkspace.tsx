'use client'
// Standar Barang & Standar Kebutuhan (SBSK) — Permendagri 19/2016 Pasal 20(2)a & b.
// Standar barang = spesifikasi acuan; standar kebutuhan = jumlah barang yang
// dibutuhkan per satuan pengukur. Dipakai RKBMD Pengadaan untuk menghitung gap
// (kebutuhan = kuantitas_standar − eksisting).
//
// PINDAH MENU 2026-08-10: dulu di Admin > Standar Kebutuhan (SBSK), sekarang
// RKBMD > Standar Harga > SBSK. Isinya dipindahkan apa adanya dari
// app/dashboard/admin/rkbmd-sbsk/page.tsx — belum ikut pola pop-up seperti
// SSH/HSPK/ASB/SBU karena bentuk datanya beda sendiri (kuantitas standar per
// satuan pengukur, bukan harga) dan user belum memintanya.
//
// Satu kopi sekabupaten per tahun; tulis hanya admin (RLS rkbmd_sbsk_write).
// Berbeda dari `rkbmd_standar` yang jadi bak bersama lintas SKPD.
...
export default function SbskWorkspace() {
  ...
  return (
    <FormShell
      ...
      deskripsi="Acuan jumlah kebutuhan barang per tahun anggaran (Permendagri 19/2016 Pasal 20). Dipakai RKBMD Pengadaan untuk menghitung gap terhadap barang eksisting. Ditetapkan admin pemda — beda dari SSH/HSPK/ASB/SBU yang jadi bak bersama lintas SKPD."
      msg={msg}
      headerRight={
        <div>
