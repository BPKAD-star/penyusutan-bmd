  ...
  return (
    <>
      {/* Logo kiri + spacer kanan selebar sama (permintaan user 2026-09-10) —
          spacer-nya WAJIB ada, bukan cuma logo tanpa pasangan, supaya blok
          judul tengah tetap benar-benar di tengah kertas (bukan cuma di
          tengah sisa ruang sebelah logo). Pola sama dgn KOP halaman KIBAR. */}
